...
export function Pricing() {
  ...
  return (
    <section id="pricing" className="from-background to-muted/20 w-full bg-gradient-to-b py-12 md:py-24 lg:py-32">
      <div className="container px-4 md:px-6 mx-auto">
        ...
        <div
          className="mt-16 grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3 lg:gap-12 max-w-7xl mx-auto"
        >
